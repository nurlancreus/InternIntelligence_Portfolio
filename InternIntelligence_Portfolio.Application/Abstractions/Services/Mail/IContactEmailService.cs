...
namespace InternIntelligence_Portfolio.Application.Abstractions.Services.Mail
{
    public interface IContactEmailService
    {
        ...
        Task<Result<bool>> SendContactResponseMessageAsync(string firstName, string lastName, string email, ContactSubject subject, string message, CancellationToken cancellationToken = default);
    }
}
